...
This report creates the CSV files with the candidate differentially expressed regions (DERs) found using `derfinder` `r citep(bib[["derfinder"]])` on four data sets. It also has Venn diagrams illustrating the overlap with known annotation. 
