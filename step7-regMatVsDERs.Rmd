...
stopifnot(all(c('fullRegions', 'regionMat') %in% ls()))
...
## Save the raw data
save(ders, file = 'dersOriginal.Rdata')
save(regs, file = 'regsOriginal.Rdata')
...
## Save data used
save(ders, file = 'ders.Rdata')
save(regs, file = 'regs.Rdata')
```
...
```{r 'save'}
save(index.all, index.num, index.seg, index.width, nOverlap20, ov20, nOverlap1, ov1, overallInfo, file = "compare-results.Rdata")
```
