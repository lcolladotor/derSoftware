...
These HTML reports contain  basic information on the `derfinder` `r citep(bib[["derfinder"]])` results from the public data sets used (_BrainSpan_, _Simulation_, _Hippo_, _Snyder_, and _Stem_). These reports answer basic questions such as:
...
* [Stem](stem/summaryInfo/run4-v1.0.10/summaryInfo.html)

## Full HTML reports

Three full HTML reports for the `derfinder` results are provided. These reports were generated using `regionReport` `r citep(bib[["regionReport"]])` and contain a lot of information including:
...
* Best regions (by area)
	* Plots from top 100 regions
	* Interactive table with data from top 500 regions.
* Plots from the top 20 region clusters (by area)
* Permutations details
* Reproducibility details including some parameters used for the `derfinder` single-base level analysis.

You can view the reports by following these links:

* [BrainSpan](brainspan/derAnalysis/run4-v1.0.10/basicExploration/basicExploration.html)
* [Simulation](simulation/derAnalysis/run2-v1.0.10/basicExploration/basicExploration.html)
* [Hippo](hippo/derAnalysis/run3-v1.0.10/basicExploration/basicExploration.html)
* [Snyder](snyder/derAnalysis/run3-v1.0.10/basicExploration/basicExploration.html)
* [Stem](stem/derAnalysis/run4-v1.0.10/basicExploration/basicExploration.html)

Note that these HTML reports are large and can take time to load properly. Please wait for them to load completely before scrolling. In particular, the report for the BrainSpan data set is a 47 MB file.
...
* [Stem (cutoff 5)](stem/regionMatrix-vs-DERs/cut5-vs-run4-v1.0.10/step7-regMatVsDERs.html)
...
* [brainspan_regionLevel](additional_analyses/brainspan_regionLevel.R) Analysis of BrainSpan expressed-regions level DERs.
* [characterize_brainspan_DERs](additional_analyses/characterize_brainspan_DERs.R) Analysis of BrainSpan single-base level DERs.
* [stem_analysis](additional_analyses/stem_analysis.R) Analysis of the Stem data set DERs.
* [feature_counts](additional_analyses/feature_counts.R) Feature counts analysis of Hippo, Snyder and Stem data sets.
