...
```{r 'analysisSumFigs', fig.width=10, bootstrap.show.code=FALSE}
...
```{r 'analysisSumFigs2', fig.width=10, bootstrap.show.code=FALSE}
...
```{r 'peakSumFigs', fig.width=10, bootstrap.show.code=FALSE}
...
```{r 'peakSumFigs2', fig.width=10, bootstrap.show.code=FALSE}
